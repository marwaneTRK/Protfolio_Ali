            ...
            {socialEntries.map((item) => (
              <li key={item.href}>
                <Link
                  ...
                  className="group flex items-center gap-3 rounded-2xl border border-white/[0.08] bg-white/[0.03] px-4 py-3 pr-5 text-sm text-white/90 backdrop-blur-md transition hover:border-[var(--gold)]/35 hover:bg-white/[0.06]"
                >
                  <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-black/30 text-[var(--gold)] transition group-hover:text-[var(--gold-bright)]">
