                  ...
                  <div className="flex flex-1 flex-col px-5 pb-6 pt-6">
                    ...
                    <div className="mt-6 flex flex-wrap gap-3">
                      <Link
                        ...
                        className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-sm font-medium text-white backdrop-blur transition hover:border-[var(--gold)]/40 hover:bg-white/10"
                      >
                        Learn more
                      ...
                      {shopUrl ? (
                        <Link
                          ...
                          className="inline-flex items-center gap-2 text-sm font-medium text-[var(--gold)] transition hover:text-[var(--gold-bright)]"
                        >
                          {brand.shopName}
                        </Link>
                      ) : null}
